                        ...
                        <div className="mt-3 space-y-2">
                          ...
                          <p className="text-xl font-bold text-red-600">
                            {(() => {
                              ...
                              return `⚠️ ${stateYears > 0 ? `${stateYears} ${stateYears === 1 ? 'an' : 'ani'}` : ''}${stateYears > 0 && stateMonthsRemainder > 0 ? ' și ' : ''}${stateMonthsRemainder > 0 ? `${stateMonthsRemainder} ${stateMonthsRemainder === 1 ? 'lună' : 'luni'}` : ''} au fost pentru stat!`;
                            })()}
                          </p>
